...
import { getTHBPricing, Duration } from "../components/PricingTabs";
...
export default function HomePage() {
  ...
  const pricing = getTHBPricing(duration);
  return (
    <div className="bg-[#f8f8f6] relative w-full h-[4500px]" data-name="Home page">
      ...
      <AbsoluteFadeIn triggerTop={70} triggerHeight={500} delay={0.2}>
        ...
        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold h-[34px] leading-[normal] left-[298px] not-italic text-[7px] text-[rgba(0,0,0,0.5)] top-[106px] w-[153px] whitespace-pre-wrap">Stop paying 120,000 Bahts agency fees. Professional, secure, and fast websites starting at 807 Bahts/Month. No deposit required.</p>
        <div className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[12px] left-[297px] not-italic text-[8px] text-black top-[72px] whitespace-nowrap">
          <p className="mb-0">{`Stop paying 120,000 Bahts agency fees. `}</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[9px] leading-[normal] left-[34px] not-italic text-[8px] text-white top-[2486px] w-[21px] whitespace-pre-wrap">THB</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[9px] leading-[normal] left-[96px] not-italic text-[8px] text-white top-[2469px] w-[44px] whitespace-pre-wrap">THB {pricing.starter.originalPrice.toLocaleString()}</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[9px] leading-[normal] left-[193px] not-italic text-[8px] text-white top-[2486px] w-[21px] whitespace-pre-wrap">THB</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[9px] leading-[normal] left-[239px] not-italic text-[8px] text-white top-[2468px] w-[43px] whitespace-pre-wrap">THB {pricing.growth.originalPrice.toLocaleString()}</p>
      ...
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[9px] leading-[normal] left-[348px] not-italic text-[8px] text-white top-[2486px] w-[22px] whitespace-pre-wrap">THB</p>
      <p className="absolute font-['Inter:Medium',sans-serif] font-medium h-[9px] leading-[normal] left-[393px] not-italic text-[8px] text-white top-[2469px] w-[51px] whitespace-pre-wrap">THB {pricing.pro.originalPrice.toLocaleString()}</p>
